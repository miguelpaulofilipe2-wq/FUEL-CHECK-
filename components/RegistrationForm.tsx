    ...
    <div className="max-w-2xl mx-auto bg-white p-6 sm:p-8 rounded-[32px] shadow-2xl border border-gray-100">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="relative">
          <select className="w-full px-4 py-3 rounded-xl border-none bg-gray-100 outline-none text-sm appearance-none" value={formData.neighborhood} onChange={e => setFormData({...formData, neighborhood: e.target.value})}>
